...
struct ContentView: View {
    let componentsList = ["Adjust position with Offset","Color padding view","Stack Modifiers","Border Around a View","Border Inside a View","Shadow around a view","Clip a view","Rotate a View","Rotate a view in 3D","Second View","Scale a view up or down","Opacity of a view"]
